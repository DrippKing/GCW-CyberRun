...
textureLoader.load("cielo_level3.png", tex => {
...
// Piso
let pisoTexture;
textureLoader.load("piso_level3.png", texture => {
...
gltfLoaderObs.load("Level3_large_error.glb", gltf => { modelLarge = gltf.scene; });
gltfLoaderObs.load("Level3_wide_error.glb", gltf => { modelWide = gltf.scene; });
