...
textureLoader.load("cielo_level1.png", tex => {
...
// Piso
let pisoTexture;
textureLoader.load("piso_level1.png", texture => {
...
gltfLoaderObs.load("level1_obtacle_large.glb", gltf => { modelLarge = gltf.scene; });
gltfLoaderObs.load("level1_obtacle_wide.glb", gltf => { modelWide = gltf.scene; });
